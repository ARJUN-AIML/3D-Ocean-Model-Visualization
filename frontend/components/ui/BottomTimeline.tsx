...
export default function BottomTimeline() {
  ...
  return (
    <div className="absolute bottom-3 left-1/2 -translate-x-1/2 z-30 w-[calc(100%-24px)] max-w-xl lg:max-w-2xl select-none pointer-events-none">
      <div className="bg-navy-deep border-2 border-navy-sky rounded-xl p-2.5 sm:p-3 shadow-panel text-navy-ice pointer-events-auto">
        <div className="flex flex-wrap sm:flex-nowrap items-center justify-between gap-2 sm:gap-4 mb-2">
          {/* Playback Actions */}
