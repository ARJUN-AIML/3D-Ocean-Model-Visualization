...
export default function RightDrawer() {
  ...
  return (
    <aside className="absolute top-20 right-3 bottom-20 z-40 w-full max-w-md bg-navy-deep border border-navy-sky/30 rounded-xl p-4 shadow-panel text-navy-ice overflow-y-auto flex flex-col justify-between select-none">
      {/* Drawer Header */}
      <div>
